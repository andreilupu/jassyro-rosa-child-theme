		...
		<h1 class="site-title site-title--image">
			<a class="site-logo  site-logo--image" href="<?php echo home_url(); ?>" title="<?php bloginfo( 'name' ) ?>" rel="home">
				...
				if ( is_woocommerce() || is_product() ) {?>
					<img class="site-logo-img--dark" src="<?php echo rosa_image_src( 'main_logo_light' ); ?>" rel="logo" alt="<?php echo get_bloginfo( 'name' ) ?>"/>
				<?php } elseif ( rosa_image_src( 'main_logo_dark' ) ) { ?>
